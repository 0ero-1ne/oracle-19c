...
INSERT INTO T_RANGE (id, value) VALUES (5, 'record 1');
INSERT INTO T_RANGE (id, value) VALUES (15, 'record 2');
INSERT INTO T_RANGE (id, value) VALUES (44, 'record 3');
...
select * from t_hash partition(sys_p628);
...
--оператором update невозможно переместить данные из одной секции в другую, если не установить ENABLE ROW MOVEMENT

update T_INTERVAL set date_column = TO_DATE('2023-09-09', 'YYYY.MM.DD') where id = 1;
