...
insert into SALESREPS values(143, 'Ilya Korobkin', 24, 23, 'Sales Rep', date('now'),106, 500000, 450000);
...
BEGIN TRANSACTION B;
UPDATE ORDERS SET CUST = 2111 WHERE ORDER_NUM = 112968;
End TRANSACTION B;
End transaction A;
commit;
...
--task 10
begin TRANSACTION A;
UPDATE ORDERS set CUST = 2103 where ORDER_NUM = 112961;
SAVEPOINT A;
update orders  set CUST = 2103 where ORDER_NUM = 112963;
RELEASE SAVEPOINT A;
